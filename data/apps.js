...
export const apps = [
  ...
  },
  {
    id: 'shop-landing',
    name: '쇼핑몰 홈페이지',
    description: 'MOODROAD — 상품 그리드와 장바구니 담기를 담은 패션 쇼핑몰 홈페이지예요.',
    tags: ['홈페이지', '쇼핑몰', '패션'],
    status: 'live',
    category: 'homepage',
    demoPath: '/apps/shop-landing',
    guidePath: '/guides/shop-landing',
    guide: {
      stack: ['Next.js', 'React', '인라인 스타일'],
      summary: '패션 편집숍을 위한 미니멀 쇼핑몰 홈페이지 데모예요. "장바구니 담기"를 누르면 실제 결제 없이 토스트 메시지만 보여줘요.',
      keyPoints: [
        '상품 배열 하나로 카드 그리드를 만들고, BEST/NEW 배지는 태그 필드 값에 따라 조건부로 렌더링해요.',
        '장바구니 담기 버튼은 setTimeout으로 잠깐 떴다 사라지는 토스트 알림만 보여주는 로컬 상태예요 — 실제 장바구니 데이터는 없어요.',
        '흑백 위주의 미니멀 팔레트로 패션 브랜드다운 톤을 만들었어요.',
      ],
      steps: [
        '상품 데이터를 이름·가격·배지 필드로 정의해요.',
        '상품 그리드를 map()으로 렌더링하고 각 카드에 담기 버튼을 붙여요.',
        '담기 버튼 클릭 시 토스트를 보여주는 boolean state를 만들고 setTimeout으로 자동으로 꺼지게 해요.',
      ],
      files: ['components/gallery/ShopLandingDemo.jsx'],
    },
  },
  {
    id: 'salon-landing',
    name: '헤어살롱 홈페이지',
    description: '글로우헤어 — 시술 메뉴·디자이너 소개·예약을 담은 뷰티샵 홈페이지예요.',
    tags: ['홈페이지', '예약', '뷰티'],
    status: 'live',
    category: 'homepage',
    demoPath: '/apps/salon-landing',
    guidePath: '/guides/salon-landing',
    guide: {
      stack: ['Next.js', 'React', '인라인 스타일'],
      summary: '예약제로 운영하는 헤어살롱을 위한 홈페이지 데모예요. 시술 메뉴와 디자이너 소개, 예약 폼을 핑크 톤으로 구성했어요.',
      keyPoints: [
        '시술 메뉴 배열이 가격 카드와 예약 폼의 select 옵션에 동시에 재사용돼요.',
        '디자이너 카드는 실제 사진 대신 이모지 아바타로 자리표시자를 채웠어요.',
        '연한 핑크·라벤더 팔레트로 뷰티샵다운 부드러운 톤을 만들었어요.',
      ],
      steps: [
        '시술 메뉴를 이름·가격 배열로 정의해요.',
        '같은 배열을 메뉴 카드 그리드와 예약 폼 select에서 재사용해요.',
        '예약 폼 제출 시 로컬 state로 "접수완료" 화면으로 전환해요.',
      ],
      files: ['components/gallery/SalonLandingDemo.jsx'],
    },
  },
  {
    id: 'academy-landing',
    name: '어학원 홈페이지',
    description: '브릿지 어학원 — 커리큘럼·수강 후기·무료 상담 신청을 담은 홈페이지예요.',
    tags: ['홈페이지', '교육', '학원'],
    status: 'live',
    category: 'homepage',
    demoPath: '/apps/academy-landing',
    guidePath: '/guides/academy-landing',
    guide: {
      stack: ['Next.js', 'React', '인라인 스타일'],
      summary: '어학원·학원을 위한 홈페이지 데모예요. 커리큘럼 레벨 배지와 수강 후기 카드로 신뢰감을 주는 구성이에요.',
      keyPoints: [
        '커리큘럼 배열에 레벨(BEGINNER/INTERMEDIATE/ADVANCED) 필드를 둬서 배지 색 없이도 텍스트만으로 난이도를 구분해요.',
        '수강 후기는 인용부호(&ldquo;/&rdquo;)로 감싸 후기임을 시각적으로 강조해요.',
        '파란색(신뢰) + 주황색(CTA 강조) 조합으로 교육 서비스다운 톤을 만들었어요.',
      ],
      steps: [
        '커리큘럼·후기 데이터를 배열로 정의해요.',
        '레벨 테스트/상담 신청 폼의 select 옵션도 커리큘럼 배열에서 가져와요.',
        'CTA 버튼 색상만 브랜드 메인 컬러와 다르게 줘서 시선을 유도해요.',
      ],
      files: ['components/gallery/AcademyLandingDemo.jsx'],
    },
  },
  {
    id: 'photographer-landing',
    name: '포토그래퍼 포트폴리오',
    description: 'STUDIO ILLUM — 작업물 갤러리와 촬영 문의를 담은 개인 포트폴리오 홈페이지예요.',
    tags: ['홈페이지', '포트폴리오', '사진'],
    status: 'live',
    category: 'homepage',
    demoPath: '/apps/photographer-landing',
    guidePath: '/guides/photographer-landing',
    guide: {
      stack: ['Next.js', 'React', '인라인 스타일'],
      summary: '개인 사진작가를 위한 블랙 톤 포트폴리오 홈페이지 데모예요. 매거진처럼 여백과 타이포그래피에 힘을 준 구성이에요.',
      keyPoints: [
        '전체 배경을 거의 검은색으로 두고 사진과 타이포그래피만 두드러지게 해서, 갤러리 사이트 특유의 몰입감을 살렸어요.',
        '작업물 그리드는 gap을 4px로 아주 좁게 둬서 인스타그램 피드 같은 밀도를 냈어요.',
        '촬영 유형(웨딩/가족/프로필 등) 배열을 작업물 그리드와 문의 폼 select에서 함께 재사용해요.',
      ],
      steps: [
        '어두운 배경 + 밝은 텍스트의 하이콘트라스트 팔레트를 정해요.',
        '작업물 배열을 좁은 gap의 그리드로 렌더링해요.',
        '촬영 문의 폼에서 같은 작업물 유형 배열을 select 옵션으로 재사용해요.',
      ],
      files: ['components/gallery/PhotographerLandingDemo.jsx'],
    },
  },
  {
    id: 'gym-landing',
    name: '헬스장 홈페이지',
    description: 'CORE GYM — PT 프로그램·가격 안내·무료 체험 신청을 담은 홈페이지예요.',
    tags: ['홈페이지', '피트니스', '헬스'],
    status: 'live',
    category: 'homepage',
    demoPath: '/apps/gym-landing',
    guidePath: '/guides/gym-landing',
    guide: {
      stack: ['Next.js', 'React', '인라인 스타일'],
      summary: '퍼스널 트레이닝 짐을 위한 다크 + 레드 톤 홈페이지 데모예요. 에너지 넘치는 느낌을 색상 대비로 표현했어요.',
      keyPoints: [
        '어두운 배경에 레드를 포인트 컬러로만 제한해서, 브랜드 컬러가 과하지 않으면서도 강렬한 인상을 줘요.',
        '프로그램 카드에 가격을 큰 폰트+포인트 컬러로 강조해 비교하기 쉽게 했어요.',
        '무료 체험 신청 폼의 프로그램 select도 같은 프로그램 배열을 재사용해요.',
      ],
      steps: [
        '다크 배경 + 포인트 컬러 하나만 쓰는 팔레트를 정해요.',
        '프로그램 데이터를 이름·설명·가격 배열로 정의해요.',
        '상담 폼에서 같은 배열을 select 옵션으로 재사용해요.',
      ],
      files: ['components/gallery/GymLandingDemo.jsx'],
    },
  },
  {
    id: 'pet-landing',
    name: '반려동물샵 홈페이지',
    description: '포포하우스 — 미용·호텔·유치원 서비스와 예약 문의를 담은 홈페이지예요.',
    tags: ['홈페이지', '반려동물', '예약'],
    status: 'live',
    category: 'homepage',
    demoPath: '/apps/pet-landing',
    guidePath: '/guides/pet-landing',
    guide: {
      stack: ['Next.js', 'React', '인라인 스타일'],
      summary: '반려동물 미용·호텔샵을 위한 따뜻한 톤의 홈페이지 데모예요. 보호자 후기 카드로 신뢰감을 더했어요.',
      keyPoints: [
        '노란색(따뜻함) + 민트(청결·안심) 두 가지 포인트 컬러를 용도별로 나눠 썼어요 — CTA는 노란색, 폼 버튼은 민트예요.',
        '서비스 카드 4개를 아이콘 + 한 줄 설명으로 단순화해서 한눈에 훑어볼 수 있게 했어요.',
        '보호자 후기는 실제 이름 대신 "OO 보호자" 형태로 표기해 개인정보 걱정 없이 신뢰감을 줘요.',
      ],
      steps: [
        '서비스 항목을 아이콘·이름·설명 배열로 정의해요.',
        '후기 카드는 인용문 스타일로 배열을 순회해 렌더링해요.',
        '예약 폼 select에도 서비스 배열을 재사용해요.',
      ],
      files: ['components/gallery/PetLandingDemo.jsx'],
    },
  },
]
